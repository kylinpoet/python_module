...
def ip_chk(ip,equ):
        #注意需要ak！
    url = 'http://api.map.baidu.com/highacciploc/v1?qcip={ip}&qterm={equ}&ak=791f999af1023394df702618d5ad3c9f&coord=bd09ll&extensions=3'.format(ip=ip,equ=equ)
    #注意需要ak！
    ...
    if c_code == 161:
            ...
            for i in list_info:
                    if c_code == i:
                            print list_info[i].encode("utf-8").decode("gb18030")
